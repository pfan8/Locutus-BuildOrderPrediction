...
GameCommander::GameCommander() 
	...
	, _surrenderTime(0)
{
	//std::ofstream fout("mapName.txt", std::ofstream::out | std::ofstream::app);
	//fout << BWAPI::Broodwar->mapHash() << endl;
	//fout.close();
}

void GameCommander::update()
{
	//BWAPI::Broodwar->printf("map name: %s", (BWAPI::Broodwar->mapHash()));
...
void GameCommander::drawDebugInterface()
{
	...
	BOSSManager::Instance().drawSearchInformation(490, 200);
